						...
						<div class="products">
							<div class="product">		
								<div class="product-image">
									...
									<div class="tag hot"><span>নতুন</span></div>	
									@else	   
									<div class="tag hot"><span>{{ price_bn(round($discount)) }}%</span></div>	
									@endif	
									@else   
									@if($product->discount_price == NULL)
				...
				<div class="category-product">			l					
						...
						@foreach($products as $product)			
							<div class="products">				
									...
									@else    
									<div class="tag new"><span>{{ price_bn(round($discount)) }}%</span></div> 
									@endif   
									@else
									@if($product->discount_price == Null)
