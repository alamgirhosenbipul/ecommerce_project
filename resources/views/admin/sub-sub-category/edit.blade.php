     ...
     <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
              ...
              <form action="{{ route('subsub.update',$subsubcat->id) }}" method="POST">
                @csrf
            ...
            <div class="row row-sm">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="subsubcategory_name_bn" placeholder="Enter subcategory name bn" value="{{ $subsubcat->subsubcategory_name_bn }}">
