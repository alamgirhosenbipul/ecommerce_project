...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('backend') }}/lib/bootstrap-tagsinput.min.css" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('frontend') }}/assets/toastr/toastr.css">

    {{-- datatable css start --}}
    <link href="{{ asset('backend') }}/lib/datatables/jquery.dataTables.css" rel="stylesheet">
    <link href="{{ asset('backend') }}/lib/highlightjs/github.css" rel="stylesheet">
        {{-- select search box code start --}}
        <link href="{{ asset('backend') }}/lib/select2/css/select2.min.css" rel="stylesheet">
        {{-- select search box code end --}}
            ...
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                ...
                <li><a href="{{ route('logout') }}"
                    ...
                    <i class="icon ion-power"></i> Sign Oute</a>
