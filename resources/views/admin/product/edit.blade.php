...
@endsection
     ...
     <div class="sl-mainpanel">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control select2-show-search" data-placeholder="Select One" name="subcategory_id">
                              ...
                              <option value="{{ $Cat->id }}"{{ $Cat->id == $product->subcategory_id ? 'selected' : '' }}>{{ ucwords($Cat->subcategory_name_en) }}</option>
                              @endforeach
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control select2-show-search" data-placeholder="Select One" name="subsubcategory_id">
                              ...
                              <option value="{{ $cat->id }}"{{ $cat->id == $product->subsubcategory_id ? 'selected' : '' }}>{{ ucwords($cat->subsubcategory_name_en) }}</option>
                              @endforeach
                            </select>
        ...
        {{-- -------------------------- --}}
          ...
          <form action="{{ route('update.productThumbnail') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row row-sm" style="margin-top:30px;">
                  <div class="col-md-3">
                    <div class="card">
                      <img class="card-img-top" src="{{ asset($product->product_thumbnail) }}" alt="Card image cap" style="height: 150px; width:150px;">
                      <div class="card-body">
                        <p class="card-text">
                          <div class="form-group">
...
{{-- //---------------------------------- --}}
          ...
          <form action="{{ route('update.productImage') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <br>
          ...
          @foreach( $multi_imgs as $img)
                  <div class="col-md-3">
                    <div class="card" >
                      ...
                      <div class="card-body">
                        <h5 class="card-title">
                          <a href="{{ url('admin/product/multiImage-delete/'.$img->id) }}" class="btn btn-sm btn-danger" id="delete" title="delete data"><i class="fa fa-trash"></i></a>
                        </h5>
                        <p class="card-text">
                          <div class="form-group">
                            <label class="form-control-label">Change Image<span class="tx-danger">*</span></label>
            ...
            if(category_id) {
                $.ajax({
                    ...
                    success:function(data) {
                      $('select[name="subsubcategory_id"]').html(''); // সাব সাব ক্যাটাগরী ফিল্ড ফাকা করার জন্য এই কোড ।
