            ...
            <div class="row row-sm">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="file" name="product_thumbnail" value="" onchange="mainThambUrl(this)">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="file" name="multi_img[]" multiple value="{{ old('multi_img') }}" multiple   id="multiImg">
                        @error('multi_img')
                        <span class="text-danger">{{ $message }}</span>
                      @enderror
                      </div>
...
// show for automatic subcategory name in field
      $(document).ready(function() {
        ...
        // show for automatic susubcategory name in field
