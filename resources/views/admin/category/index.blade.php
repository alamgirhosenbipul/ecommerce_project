          ...
          <div class="card">
            ...
            <form action="{{ route('category.store') }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="category_icon" placeholder="Category icon" value="{{ old('category_icon') }}">
                  @error("category_icon")
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="category_name_en" placeholder="Category name english" value="{{ old('category_name_en') }}">
